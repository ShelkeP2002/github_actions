...
TC-09 Verify the UI of the layout of OTP screen
    ...
    Compare Images    Reports/Screenshots/reference_screenshots/otp_page_screenshot.png    ${cropped_image}
...
TC-9 Verify the UI of the layout of OTP screen with Actual SS
    ...
    Compare Images    Reports/Screenshots/reference_screenshots/otp_page_screenshot_actual.png    ${cropped_image}
